...
3. **Local consequence annotation** (`annotate_panel.py`): MANE-transcript classifier (GTF + GRCh38 no-alt FASTA, pyfaidx) labeling stop-gain/frameshift/splice/missense; [VEP REST](https://rest.ensembl.org/) cross-verified on every final candidate (canonical ENST00000287598.11).
...
5. **Splice assessment**: [SpliceAI](https://doi.org/10.1016/j.cell.2018.12.015) 1.3.1 ([Jaganathan et al.](https://doi.org/10.1016/j.cell.2018.12.015)), distance 1000, unmasked — all BUB1B candidates ≤0.03; the novel deep-intronic c.2679-1026A>G scored 0.00.
