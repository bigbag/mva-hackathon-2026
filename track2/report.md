...
Each step uses an API or a public dataset. [Open Targets](https://platform.opentargets.org/target/ENSG00000156970) comes from [`track1/analysis/ot_client.py`](https://github.com/bigbag/mva-hackathon-2026/blob/main/track1/analysis/ot_client.py) and lands in [`track2/evidence/ot_bub1b_profile.json`](https://github.com/bigbag/mva-hackathon-2026/blob/main/track2/evidence/ot_bub1b_profile.json). [DGIdb](https://www.dgidb.org/) and [ChEMBL](https://www.ebi.ac.uk/chembl/explore/target/CHEMBL5491) land in [`track2/evidence/dgidb_tiers.json`](https://github.com/bigbag/mva-hackathon-2026/blob/main/track2/evidence/dgidb_tiers.json) and [`track2/evidence/chembl_feasibility.json`](https://github.com/bigbag/mva-hackathon-2026/blob/main/track2/evidence/chembl_feasibility.json). The [everycure/matrix-scores](https://huggingface.co/datasets/everycure/matrix-scores) scan lands in [`track2/evidence/matrix_scores_matches.csv`](https://github.com/bigbag/mva-hackathon-2026/blob/main/track2/evidence/matrix_scores_matches.csv). The deck is built by [`track2/slides/build_assets.py`](https://github.com/bigbag/mva-hackathon-2026/blob/main/track2/slides/build_assets.py). File map: [`track2/README.md`](https://github.com/bigbag/mva-hackathon-2026/blob/main/track2/README.md). The pipeline runs on a laptop. The pipeline applies to other recessive chromosomal-instability disorders.
